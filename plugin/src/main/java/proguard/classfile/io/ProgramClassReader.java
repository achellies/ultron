...
public class ProgramClassReader
    ...
    private TargetInfo createTargetInfo() {
        ...
        switch (u1targetType) {
            ...
            case ClassConstants.ANNOTATION_TARGET_ParameterGenericMethod:
                return new TypeParameterTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_Extends:
                return new SuperTypeTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_BoundGenericClass:
            case ClassConstants.ANNOTATION_TARGET_BoundGenericMethod:
            ...
            case ClassConstants.ANNOTATION_TARGET_Receiver:
                return new EmptyTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_Parameter:
                return new FormalParameterTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_Throws:
                return new ThrowsTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_LocalVariable:
            case ClassConstants.ANNOTATION_TARGET_ResourceVariable:
                return new LocalVariableTargetInfo(u1targetType);
            case ClassConstants.ANNOTATION_TARGET_Catch:
            ...
            case ClassConstants.ANNOTATION_TARGET_MethodReference:
            ...
            case ClassConstants.ANNOTATION_TARGET_ArgumentGenericMethodReference:
    ...
    private ElementValue createElementValue() {
        ...
        switch (u1tag) {
            ...
            case ClassConstants.ELEMENT_VALUE_STRING_CONSTANT:
                return new ConstantElementValue((char) u1tag);

            case ClassConstants.ELEMENT_VALUE_ENUM_CONSTANT:
                return new EnumConstantElementValue();
            case ClassConstants.ELEMENT_VALUE_CLASS:
                return new ClassElementValue();
            case ClassConstants.ELEMENT_VALUE_ANNOTATION:
                return new AnnotationElementValue();
            case ClassConstants.ELEMENT_VALUE_ARRAY:
