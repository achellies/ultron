...
public class IncrementalVisitor2 extends ClassVisitor {

    private static final ILogger LOG = LoggerWrapper.getLogger(IncrementalVisitor2.class);
    ...
    public interface VisitorBuilder {
        @NonNull
        IncrementalVisitor2 build(@NonNull ClassNode classNode,
    ...
    public static File instrumentClass(
        ...
        Files.createParentDirs(outputFile);
        IncrementalVisitor2 visitor = visitorBuilder.build(classNode, parentsNodes, classWriter);
        ...
        while (currentParentName != null) {
            ...
            if (parentFile.exists()) {
                ...
                try {
                    ...
                    LOG.warning("IncrementalVisitor2 parseParents could not locate %1$s "
