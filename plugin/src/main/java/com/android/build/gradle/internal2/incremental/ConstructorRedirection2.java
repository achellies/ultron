 ...
 */
public class ConstructorRedirection2 extends com.android.build.gradle.internal2.incremental.Redirection {
    ...
    static final String DISPATCHING_THIS_SIGNATURE =
            "([Ljava/lang/Object;"
                    + IncrementalVisitor2.INSTANT_RELOAD_EXCEPTION.getDescriptor() + ")V";
     ...
     */
    ConstructorRedirection2(LabelNode label,
    ...
    protected void doRedirect(GeneratorAdapter mv, int change) {
        ...
        mv.invokeInterface(IncrementalVisitor2.CHANGE_TYPE, Method.getMethod("Object access$dispatch(String, Object[])"));
